...
The 19 primitive types, each shown with 2–3 variants illustrating its degrees of
...
All 105 hand-written archetypes in `ARCHETYPE_REGISTRY` (`src/archetypes.py`),
built from the 19 primitive types (box, cylinder, sphere, capsule, cone, pyramid,
