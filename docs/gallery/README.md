...
The 13 primitive types, each shown with 2–3 variants illustrating its degrees of
...
built from the 13 primitive types (box, cylinder, sphere, capsule, cone, pyramid,
