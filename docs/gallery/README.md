...
The 11 primitive types, each shown with 2–3 variants illustrating its degrees of
...
built from the 11 primitive types (box, cylinder, sphere, capsule, cone, pyramid,
